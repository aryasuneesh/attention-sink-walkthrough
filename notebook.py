...
def _(mo):
    ...
    <style>
      ...
      */
      ...
      .as-val {
        font-family: var(--marimo-heading-font);
        font-size: 2em; font-weight: 700; color: #f59e0b; line-height: 1; margin-bottom: 4px;
      }
...
def _(alt, mo, pl):
    ...
    mo.vstack([
        mo.Html("""<div class="as-grid">
          ...
          <div class="as-card"><div class="as-val" style="color:#6d28d9">0.00%</div>
          ...
          <div class="as-card"><div class="as-val" style="color:#6d28d9">28.49%</div>
